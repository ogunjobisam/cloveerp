...
| **Build**              | Every migration applied on every push — to a base a previous build proved, and nightly to an empty database — then <!-- count:catalogue_checks -->339<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->522<!-- /count --> migrations and
<!-- count:sql_lines -->323393<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->238<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4966<!-- /count --> English strings, a German core pack
of <!-- count:de_strings -->696<!-- /count -->, a tenant's own terms under
...
assertions, <!-- count:suites -->238<!-- /count --> adversarial suites, the
