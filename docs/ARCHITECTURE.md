...
| **Build**              | Every migration applied on every push — to a base a previous build proved, and nightly to an empty database — then <!-- count:catalogue_checks -->349<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:sql_lines -->335484<!-- /count --> lines of SQL.
...
<!-- count:en_strings -->5091<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->248<!-- /count --> adversarial suites, the
