...
| **Interface**          | An application over a curated API of <!-- count:doors -->669<!-- /count --> doors; a scan-first device client; a platform console; a status page.                                                                                                                             |
...
<!-- count:sql_lines -->255465<!-- /count --> lines of SQL.
...
| `public`      | <!-- count:doors -->669<!-- /count --> functions                                                  | The only surface PostgREST exposes                                                       |
...
<!-- count:en_strings -->4404<!-- /count --> English strings, a German core pack
