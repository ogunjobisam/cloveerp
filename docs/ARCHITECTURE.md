...
| **Build**              | Every migration applied on every push — to a base a previous build proved, and nightly to an empty database — then <!-- count:catalogue_checks -->369<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->568<!-- /count --> migrations and
<!-- count:sql_lines -->359286<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->268<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->5319<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->268<!-- /count --> adversarial suites, the
...
<!-- count:diagnostic_checks -->129<!-- /count --> registered diagnostics
