...
| **Interface**          | An application over a curated API of <!-- count:doors -->670<!-- /count --> doors; a scan-first device client; a platform console; a status page.                                                                                                                             |
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->266<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->410<!-- /count --> migrations and
<!-- count:sql_lines -->257643<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->178<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
| `public`      | <!-- count:doors -->670<!-- /count --> functions                                                  | The only surface PostgREST exposes                                                       |
...
<!-- count:en_strings -->4425<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->178<!-- /count --> adversarial suites, the
