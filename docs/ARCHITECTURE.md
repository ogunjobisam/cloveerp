...
| **Interface**          | An application over a curated API of <!-- count:doors -->640<!-- /count --> doors; a scan-first device client; a platform console; a status page.                                                                                                                             |
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->228<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->370<!-- /count --> migrations and
<!-- count:sql_lines -->230952<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->145<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
| `public`      | <!-- count:doors -->640<!-- /count --> functions                                                  | The only surface PostgREST exposes                                                       |
...
<!-- count:en_strings -->4086<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->145<!-- /count --> adversarial suites, the
