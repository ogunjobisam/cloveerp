...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->288<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->444<!-- /count --> migrations and
<!-- count:sql_lines -->284256<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->198<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4673<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->198<!-- /count --> adversarial suites, the
