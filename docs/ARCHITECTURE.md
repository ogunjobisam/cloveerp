...
<!-- count:sql_lines -->284411<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->199<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4672<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->199<!-- /count --> adversarial suites, the
...
<!-- count:diagnostic_checks -->113<!-- /count --> registered diagnostics
