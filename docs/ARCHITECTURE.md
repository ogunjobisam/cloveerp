...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->303<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:sql_lines -->293280<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->208<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4884<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->208<!-- /count --> adversarial suites, the
