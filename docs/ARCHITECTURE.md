...
| **Interface**          | An application over a curated API of <!-- count:doors -->666<!-- /count --> doors; a scan-first device client; a platform console; a status page.                                                                                                                             |
...
<!-- count:sql_lines -->254219<!-- /count --> lines of SQL.
...
| `public`      | <!-- count:doors -->666<!-- /count --> functions                                                  | The only surface PostgREST exposes                                                       |
