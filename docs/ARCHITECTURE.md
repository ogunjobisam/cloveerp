...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->325<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->489<!-- /count --> migrations and
<!-- count:sql_lines -->307571<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->224<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
assertions, <!-- count:suites -->224<!-- /count --> adversarial suites, the
...
<!-- count:diagnostic_checks -->125<!-- /count --> registered diagnostics
