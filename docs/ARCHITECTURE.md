...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->218<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->358<!-- /count --> migrations and
<!-- count:sql_lines -->213690<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->135<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->3753<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->135<!-- /count --> adversarial suites, the
