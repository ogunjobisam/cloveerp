...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->301<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->460<!-- /count --> migrations and
<!-- count:sql_lines -->292625<!-- /count --> lines of SQL.
...
<!-- count:en_strings -->4879<!-- /count --> English strings, a German core pack
...
check the build can call — <!-- count:assertions -->113<!-- /count --> structural
...
<!-- count:diagnostic_checks -->121<!-- /count --> registered diagnostics
(<!-- count:diagnostic_checks_in_ci -->99<!-- /count --> of them also in CI) and
