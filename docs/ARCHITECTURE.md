...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->306<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->466<!-- /count --> migrations and
<!-- count:sql_lines -->296469<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->210<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4887<!-- /count --> English strings, a German core pack
...
check the build can call — <!-- count:assertions -->114<!-- /count --> structural
assertions, <!-- count:suites -->210<!-- /count --> adversarial suites, the
