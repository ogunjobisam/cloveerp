...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->199<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->343<!-- /count --> migrations and
<!-- count:sql_lines -->198143<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->118<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
assertions, <!-- count:suites -->118<!-- /count --> adversarial suites, the
