...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->265<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->409<!-- /count --> migrations and
<!-- count:sql_lines -->256867<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->177<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4411<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->177<!-- /count --> adversarial suites, the
