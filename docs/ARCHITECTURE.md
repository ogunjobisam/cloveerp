...
| **Build**              | Every migration applied on every push — to a base a previous build proved, and nightly to an empty database — then <!-- count:catalogue_checks -->357<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->552<!-- /count --> migrations and
<!-- count:sql_lines -->343292<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->256<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
assertions, <!-- count:suites -->256<!-- /count --> adversarial suites, the
