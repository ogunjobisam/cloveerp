...
| **Build**              | Every migration applied on every push — to a base a previous build proved, and nightly to an empty database — then <!-- count:catalogue_checks -->371<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->572<!-- /count --> migrations and
<!-- count:sql_lines -->365244<!-- /count --> lines of SQL.
...
<!-- count:policy_decisions -->36<!-- /count --> policy decisions the build took
...
| `erp_test`    | <!-- count:suites -->270<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->5348<!-- /count --> English strings, a German core pack
...
check the build can call — <!-- count:assertions -->120<!-- /count --> structural
assertions, <!-- count:suites -->270<!-- /count --> adversarial suites, the
...
<!-- count:diagnostic_checks -->130<!-- /count --> registered diagnostics
