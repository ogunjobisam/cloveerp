...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->320<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->480<!-- /count --> migrations and
<!-- count:sql_lines -->305153<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->222<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4904<!-- /count --> English strings, a German core pack
of <!-- count:de_strings -->694<!-- /count -->, a tenant's own terms under
...
assertions, <!-- count:suites -->222<!-- /count --> adversarial suites, the
