...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->282<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:sql_lines -->278769<!-- /count --> lines of SQL.
...
<!-- count:en_strings -->4627<!-- /count --> English strings, a German core pack
