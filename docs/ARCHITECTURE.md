...
| **Build**              | Every migration applied to an empty database on every push, then <!-- count:catalogue_checks -->243<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->386<!-- /count --> migrations and
<!-- count:sql_lines -->243462<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->158<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->4321<!-- /count --> English strings, a German core pack
of <!-- count:de_strings -->681<!-- /count -->, a tenant's own terms under
...
assertions, <!-- count:suites -->158<!-- /count --> adversarial suites, the
