...
| **Build**              | Every migration applied on every push — to a base a previous build proved, and nightly to an empty database — then <!-- count:catalogue_checks -->356<!-- /count --> catalogue checks, three rehearsals against a stub endpoint, and the checks that every door and every screen string has a home.                              |
...
<!-- count:migrations -->550<!-- /count --> migrations and
<!-- count:sql_lines -->342348<!-- /count --> lines of SQL.
...
| `erp_test`    | <!-- count:suites -->255<!-- /count --> suites                                                    | The harness. Suites build their own organisations, attack them, and roll them back       |
...
<!-- count:en_strings -->5161<!-- /count --> English strings, a German core pack
...
assertions, <!-- count:suites -->255<!-- /count --> adversarial suites, the
