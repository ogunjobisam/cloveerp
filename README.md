...
| Verification           | <!-- count:catalogue_checks -->320<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->116<!-- /count --> structural assertions, <!-- count:suites -->222<!-- /count --> adversarial suites |
