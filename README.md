...
<<<<<<< HEAD
| Schema                 | <!-- count:migrations -->501<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->76<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->331<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->118<!-- /count --> structural assertions, <!-- count:suites -->230<!-- /count --> adversarial suites |
=======
| Schema                 | <!-- count:migrations -->501<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->76<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->688<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->3<!-- /count --> waiting for a screen                                                                 |
| Part 5 capabilities    | <!-- count:part5_built -->97<!-- /count --> built, <!-- count:part5_partial -->0<!-- /count --> partial, <!-- count:part5_absent -->1<!-- /count --> absent by a recorded decision, of <!-- count:part5_total -->98<!-- /count -->       |
