...
| Schema                 | <!-- count:migrations -->348<!-- /count --> migrations, <!-- count:erp_tables -->249<!-- /count --> tenant tables, <!-- count:ref_tables -->75<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->204<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->97<!-- /count --> structural assertions, <!-- count:suites -->122<!-- /count --> adversarial suites |
