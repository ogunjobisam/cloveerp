...
| Verification           | <!-- count:catalogue_checks -->293<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->110<!-- /count --> structural assertions, <!-- count:suites -->201<!-- /count --> adversarial suites |
