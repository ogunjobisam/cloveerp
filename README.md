...
| Schema                 | <!-- count:migrations -->392<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->69<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->251<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->101<!-- /count --> structural assertions, <!-- count:suites -->165<!-- /count --> adversarial suites |
