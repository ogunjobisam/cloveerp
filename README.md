...
| Schema                 | <!-- count:migrations -->334<!-- /count --> migrations, <!-- count:erp_tables -->248<!-- /count --> tenant tables, <!-- count:ref_tables -->72<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
