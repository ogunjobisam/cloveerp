...
| Schema                 | <!-- count:migrations -->343<!-- /count --> migrations, <!-- count:erp_tables -->249<!-- /count --> tenant tables, <!-- count:ref_tables -->74<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->618<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->4<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->199<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->96<!-- /count --> structural assertions, <!-- count:suites -->118<!-- /count --> adversarial suites |
