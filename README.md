...
| Schema                 | <!-- count:migrations -->459<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->73<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->302<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->113<!-- /count --> structural assertions, <!-- count:suites -->207<!-- /count --> adversarial suites |
