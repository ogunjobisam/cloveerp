...
| Schema                 | <!-- count:migrations -->458<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->73<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->299<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->112<!-- /count --> structural assertions, <!-- count:suites -->205<!-- /count --> adversarial suites |
