...
| Schema                 | <!-- count:migrations -->382<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->66<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->650<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->3<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->240<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->100<!-- /count --> structural assertions, <!-- count:suites -->155<!-- /count --> adversarial suites |
...
| Languages              | English and a German core pack (<!-- count:de_strings -->673<!-- /count --> strings) with fallback; <!-- count:legislation_packs -->4<!-- /count --> legislation packs with provenance                                                    |
