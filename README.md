...
| Schema                 | <!-- count:migrations -->351<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->210<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->97<!-- /count --> structural assertions, <!-- count:suites -->128<!-- /count --> adversarial suites |
