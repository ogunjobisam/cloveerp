...
| Schema                 | <!-- count:migrations -->399<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->69<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->255<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->102<!-- /count --> structural assertions, <!-- count:suites -->168<!-- /count --> adversarial suites |
