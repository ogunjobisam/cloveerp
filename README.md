...
| Verification           | <!-- count:catalogue_checks -->298<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->111<!-- /count --> structural assertions, <!-- count:suites -->205<!-- /count --> adversarial suites |
