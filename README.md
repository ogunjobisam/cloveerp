...
| Schema                 | <!-- count:migrations -->381<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->66<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->649<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->3<!-- /count --> waiting for a screen                                                                 |
