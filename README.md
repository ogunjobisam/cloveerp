...
| Verification           | <!-- count:catalogue_checks -->256<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->102<!-- /count --> structural assertions, <!-- count:suites -->169<!-- /count --> adversarial suites |
