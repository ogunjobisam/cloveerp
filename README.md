...
| Schema                 | <!-- count:migrations -->539<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->76<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->694<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->3<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->349<!-- /count --> catalogue checks, walked on every change to what they read and nightly from an empty database: <!-- count:assertions -->118<!-- /count --> structural assertions, <!-- count:suites -->248<!-- /count --> adversarial suites |
...
| Languages              | English and a German core pack (<!-- count:de_strings -->700<!-- /count --> strings) with fallback; <!-- count:legislation_packs -->4<!-- /count --> legislation packs with provenance                                                    |
