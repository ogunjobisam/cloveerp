...
| Schema                 | <!-- count:migrations -->357<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->65<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->217<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->98<!-- /count --> structural assertions, <!-- count:suites -->134<!-- /count --> adversarial suites |
