...
| Schema                 | <!-- count:migrations -->353<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->213<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->98<!-- /count --> structural assertions, <!-- count:suites -->130<!-- /count --> adversarial suites |
