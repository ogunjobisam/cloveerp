...
| Schema                 | <!-- count:migrations -->477<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->74<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->686<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->3<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->317<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->116<!-- /count --> structural assertions, <!-- count:suites -->219<!-- /count --> adversarial suites |
...
| Languages              | English and a German core pack (<!-- count:de_strings -->692<!-- /count --> strings) with fallback; <!-- count:legislation_packs -->4<!-- /count --> legislation packs with provenance                                                    |
