...
| Verification           | <!-- count:catalogue_checks -->252<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->101<!-- /count --> structural assertions, <!-- count:suites -->166<!-- /count --> adversarial suites |
