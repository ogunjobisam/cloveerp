...
| Verification           | <!-- count:catalogue_checks -->202<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->97<!-- /count --> structural assertions, <!-- count:suites -->120<!-- /count --> adversarial suites |
