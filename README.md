...
| Verification           | <!-- count:catalogue_checks -->280<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->106<!-- /count --> structural assertions, <!-- count:suites -->192<!-- /count --> adversarial suites |
