...
| Schema                 | <!-- count:migrations -->466<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->73<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->683<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->3<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->306<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->114<!-- /count --> structural assertions, <!-- count:suites -->210<!-- /count --> adversarial suites |
