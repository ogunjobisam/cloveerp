...
| Schema                 | <!-- count:migrations -->362<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->65<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->627<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->4<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->221<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->98<!-- /count --> structural assertions, <!-- count:suites -->138<!-- /count --> adversarial suites |
