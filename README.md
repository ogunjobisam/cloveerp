...
| Verification           | <!-- count:catalogue_checks -->297<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->111<!-- /count --> structural assertions, <!-- count:suites -->204<!-- /count --> adversarial suites |
