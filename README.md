...
| Schema                 | <!-- count:migrations -->352<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->621<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->4<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->211<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->97<!-- /count --> structural assertions, <!-- count:suites -->129<!-- /count --> adversarial suites |
