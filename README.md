...
| Schema                 | <!-- count:migrations -->404<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->70<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->259<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->103<!-- /count --> structural assertions, <!-- count:suites -->172<!-- /count --> adversarial suites |
