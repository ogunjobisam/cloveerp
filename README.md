...
| Verification           | <!-- count:catalogue_checks -->324<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->118<!-- /count --> structural assertions, <!-- count:suites -->223<!-- /count --> adversarial suites |
