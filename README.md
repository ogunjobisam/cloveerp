...
| Schema                 | <!-- count:migrations -->462<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->73<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->305<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->114<!-- /count --> structural assertions, <!-- count:suites -->209<!-- /count --> adversarial suites |
