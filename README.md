...
| Schema                 | <!-- count:migrations -->377<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->66<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->235<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->99<!-- /count --> structural assertions, <!-- count:suites -->151<!-- /count --> adversarial suites |
