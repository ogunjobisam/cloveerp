...
| Verification           | <!-- count:catalogue_checks -->300<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->112<!-- /count --> structural assertions, <!-- count:suites -->206<!-- /count --> adversarial suites |
