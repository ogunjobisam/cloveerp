...
| Schema                 | <!-- count:migrations -->336<!-- /count --> migrations, <!-- count:erp_tables -->248<!-- /count --> tenant tables, <!-- count:ref_tables -->72<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->606<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->4<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->196<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->94<!-- /count --> structural assertions, <!-- count:suites -->116<!-- /count --> adversarial suites |
...
| Languages              | English and a German core pack (<!-- count:de_strings -->568<!-- /count --> strings) with fallback; <!-- count:legislation_packs -->4<!-- /count --> legislation packs with provenance                                                    |
