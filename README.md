...
| Verification           | <!-- count:catalogue_checks -->282<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->106<!-- /count --> structural assertions, <!-- count:suites -->194<!-- /count --> adversarial suites |
