...
| Verification           | <!-- count:catalogue_checks -->303<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->113<!-- /count --> structural assertions, <!-- count:suites -->208<!-- /count --> adversarial suites |
