...
| Schema                 | <!-- count:migrations -->548<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->77<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->697<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->3<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->354<!-- /count --> catalogue checks, walked on every change to what they read and nightly from an empty database: <!-- count:assertions -->119<!-- /count --> structural assertions, <!-- count:suites -->253<!-- /count --> adversarial suites |
