...
| Schema                 | <!-- count:migrations -->361<!-- /count --> migrations, <!-- count:erp_tables -->250<!-- /count --> tenant tables, <!-- count:ref_tables -->76<!-- /count --> product-content tables, <!-- count:meta_tables -->65<!-- /count --> platform tables |
| Public API             | <!-- count:doors -->625<!-- /count --> doors, every one with a screen or a registered caller; <!-- count:doors_pending_screen -->4<!-- /count --> waiting for a screen                                                                 |
...
| Verification           | <!-- count:catalogue_checks -->220<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->98<!-- /count --> structural assertions, <!-- count:suites -->137<!-- /count --> adversarial suites |
...
| Languages              | English and a German core pack (<!-- count:de_strings -->574<!-- /count --> strings) with fallback; <!-- count:legislation_packs -->4<!-- /count --> legislation packs with provenance                                                    |
