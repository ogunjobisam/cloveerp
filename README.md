...
| Schema                 | <!-- count:migrations -->438<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->77<!-- /count --> product-content tables, <!-- count:meta_tables -->71<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->283<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->107<!-- /count --> structural assertions, <!-- count:suites -->194<!-- /count --> adversarial suites |
