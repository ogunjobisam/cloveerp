...
| Schema                 | <!-- count:migrations -->442<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->77<!-- /count --> product-content tables, <!-- count:meta_tables -->71<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->286<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->108<!-- /count --> structural assertions, <!-- count:suites -->196<!-- /count --> adversarial suites |
