...
| Schema                 | <!-- count:migrations -->480<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->74<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->319<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->116<!-- /count --> structural assertions, <!-- count:suites -->221<!-- /count --> adversarial suites |
