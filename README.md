...
| Schema                 | <!-- count:migrations -->570<!-- /count --> migrations, <!-- count:erp_tables -->251<!-- /count --> tenant tables, <!-- count:ref_tables -->78<!-- /count --> product-content tables, <!-- count:meta_tables -->77<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->369<!-- /count --> catalogue checks, walked on every change to what they read and nightly from an empty database: <!-- count:assertions -->119<!-- /count --> structural assertions, <!-- count:suites -->268<!-- /count --> adversarial suites |
