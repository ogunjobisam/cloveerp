...
| Schema                 | <!-- count:migrations -->345<!-- /count --> migrations, <!-- count:erp_tables -->249<!-- /count --> tenant tables, <!-- count:ref_tables -->74<!-- /count --> product-content tables, <!-- count:meta_tables -->64<!-- /count --> platform tables |
...
| Verification           | <!-- count:catalogue_checks -->201<!-- /count --> catalogue checks run from an empty database on every push: <!-- count:assertions -->96<!-- /count --> structural assertions, <!-- count:suites -->120<!-- /count --> adversarial suites |
