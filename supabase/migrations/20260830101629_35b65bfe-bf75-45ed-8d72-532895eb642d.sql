...
begin
  ...
  -- Master data first, because history needs something to be about.
  begin
    perform erp.seed_demo_master_data();
  ...
  -- Prefer the demo codes, but take whatever this tenant actually has.
