...
as $$
  ...
  -- is already listed, so it adds nothing here (20260915070000).
...
declare
  ...
  v_new    constant text := $n$  return erp.without_cost_or_margin(jsonb_build_object(
    ...
    -- invoice was when the drain claimed it (20260915070000).
    'kind', e.kind,
...
declare
  ...
  -- chasing an invoice does not renumber the invoice (20260915070000).
...
comment on column erp_meta.commercial_email.delivery_state is
  'The last thing the provider said about this message (20260915070000): sent, '
