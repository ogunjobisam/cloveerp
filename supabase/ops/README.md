...
Clove ERP from nothing, and CI proves every night that it still does, and on
every push that what the push adds applies to a base it proved before. A script
