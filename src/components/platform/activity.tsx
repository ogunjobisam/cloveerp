          ...
          fields: [
            {
              kind: "text",
              name: "p_access_id",
              label: "Support access id",
              required: true,
              placeholder: "0f9c1a2e-…",
              hint: "Copy it from the open support access listed on this page.",
            },
            {
              kind: "text",
              name: "p_action",
            ...
            },
            {
              kind: "text",
              name: "p_object_type",
              label: "Kind of record touched",
              placeholder: "document",
              hint: "Optional. For example document, journal or item.",
            },
            {
              kind: "text",
              name: "p_object_id",
              label: "Record id",
              placeholder: "0f9c1a2e-…",
              hint: "Optional. The record that was looked at.",
            },
            {
              kind: "choice",
              name: "p_is_write",
